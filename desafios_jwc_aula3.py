...
# Código:
criador_do_Git= "Linus Torvalds e "
criador_do_GitHub= "do GitHub foram 3 criadores: Tom Preston-Werner, Chris Wansthath, P.J. Hyett e Scott Chacon" 
print( "A) Os criadores do Git E do GitHub são, respectivamente: " + criador_do_Git + criador_do_GitHub )

empresa_compradora_do_GitHub=" Microsoft"
valor_da_venda_do_GitHub= "7,5 bilhões"
print("B) A empresa que o Github foi vendido e o seu valor aproximado foi, respectivamente: " + empresa_compradora_do_GitHub + valor_da_venda_do_GitHub)

dois_subservidores_concorrentes_do_GitHub= " Bitbucket e Codeberg"
print( "C)Dois subservidores concorrentes do GitHub: " + dois_subservidores_concorrentes_do_GitHub )
...
print("2.Verificar o status atual dos arquivos(o que foi alterado): git status")
print("3.Adicionar arquivos para a área de preparação para serem salvos: git add")
print("4.Salvar as alterações criando um ponto na história com uma mensagem: git push")
